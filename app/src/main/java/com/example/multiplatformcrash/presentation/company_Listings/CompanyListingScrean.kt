...
fun CompanyListingsScrean(
   // navigator: DestinationsNavigator,
    viewModel: CompanyListingsVireModel= hiltViewModel()
){
    val swipRefreshState= rememberSwipeRefreshState(
            ...
            LazyColumn(modifier = Modifier.fillMaxSize()){
                items(state.companies.size){i ->
                    ...
                    CompanyItem(company = company, modifier = Modifier
                        ...
                        .clickable {
                           // navigator.navigate(
                                //CompanyinfoScreanDestination(company.symbol)
                           // )
